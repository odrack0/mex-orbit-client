...
## Por qué la alta lleva glow (histórico)

Aquí vivía la tabla de emisión media-vs-alta medida con `medir_emision.tscn`. **La escena se
retiró el 1-sep-2026** junto con el PNG horneado: no hay media que homologar contra alta porque la
malla es el único cuerpo en los tres niveles. Lo que sigue vigente es la lección: la emisión de un
material se lee «encendida» solo con `glow_enabled`; sin él se recorta a 1.0 y parece «claro».
